...
export const metadata = {
  ...
  keywords: [
    ...
    'Bangladesh landing page builder',
  ],
  ...
  openGraph: {
    ...
    description: 'Build beautiful ad and ecommerce landing pages with images, prices, WhatsApp and order forms.',
    locale: 'en_US',
  },
  twitter: {
...
export default function RootLayout({ children }) {
  return <ClerkProvider><html lang="en"><body><AuthBar />{children}</body></html></ClerkProvider>;
}
