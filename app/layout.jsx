...
import FreePageQuota from '../components/FreePageQuota';

export const metadata = {
  metadataBase: new URL('https://adpage-builder-v3-pied.vercel.app'),
  title: { default: 'AdPage Builder – Create Landing Pages & Publish Online', template: '%s | AdPage Builder' },
  ...
  applicationName: 'AdPage Builder', authors: [{ name: 'AdPage Builder' }], creator: 'AdPage Builder', publisher: 'AdPage Builder',
...
export default function RootLayout({ children }) {
  return <ClerkProvider><html lang="en"><body><AuthBar /><DragDropEnhancer /><FreePageQuota />{children}</body></html></ClerkProvider>;
}
